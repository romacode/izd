...
**!:** Зайди на сайт [imena.org](http://www.imena.org/name.html). Откуда [igName](http://soft.softodrom.ru/ap/igName-p4434), собственно, и родом. Там даны имена и&nbsp;значения имён.

**!:** При желании упороться именами в полный рост можно заглянуть на [Имена](http://www.imena.org/), откуда **igName**, собственно, родом.

...
**!:** Используй программу [igName](http://soft.softodrom.ru/ap/igName-p4434) или зайди на сайт [imena.org](http://www.imena.org/name.html) (откуда igName, собственно, и родом). Там даны и&nbsp;имена и&nbsp;значения имён. 

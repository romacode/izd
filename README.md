...
2. Дай ссылку на&nbsp;рассказ и добавьте две строчки информации: жанр, теги (пример: грязный реализм, ЕОТ, наркотики, расчленёнка)

3. Выбери из&nbsp;всего текста пару любимых абзацев и&nbsp;отправить их&nbsp;прямо в&nbsp;оп-посте. Эта рекомендация на&nbsp;данный момент упорно игнорируется большинством графоманов. Стань одним из&nbsp;меньшинства, покажи, что ты&nbsp;действительно не&nbsp;такой, как все.

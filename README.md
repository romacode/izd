...
Ставьте тире вместо дефиса `Ctrl+C` &rarr; `—` или `Alt+0151`. Самые трудолюбивые могут ставить вместо знаков `&quot;` красивые кавычки, ёлочки: `«Alt+0171 и Alt+0187»`. Одобрено [Тёмой Лебедевым](http://www.artlebedev.ru/kovodstvo/sections/104/). Илья Бирман сделал годную [типографскую раскладку](http://ilyabirman.ru/projects/typography-layout/).
